...
# Developed with PyQt5 by Dhanush H V
...
class Ui_PyCOL(object):
    def setupUi(self, PyCOL):
        ...
        PyCOL.resize(355, 555)
        PyCOL.setMinimumSize(QtCore.QSize(355, 555))
        PyCOL.setMaximumSize(QtCore.QSize(355, 555))
    ...
    def retranslateUi(self, PyCOL):
        ...
        PyCOL.setWindowTitle(_translate("PyCOL", "PyCOL"))
